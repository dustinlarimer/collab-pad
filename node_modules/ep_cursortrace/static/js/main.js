...
exports.handleClientMessage_CUSTOM = function(hook, context, cb){
  ...
  if(action === 'cursorPosition'){ // someone has requested we approve their rtc request - we recieved an offer
    ...
    if ( div.length !== 0 ) {
      var top = $(div).offset().top + 7; // A standard generic offset
      ...
      $.each(users, function(user, value){
        if(value.userId == authorId){
          ...
          var $indicator = $("<div class='caretindicator "+ location+ " caret-"+authorClass+"' style='height:"+height+"px;left:0px;top:"+top +"px;background-color:"+color+"' title="+authorName+"></div>");
